...
const img = new Image();
img.src = '/assets/learning-webassembly-10-image-processing-in-assemblyscript/waterlily.png';
...
async function loadWasm() {
  ...
  const wasm = await WebAssembly
    .instantiateStreaming(fetch('/assets/learning-webassembly-10-image-processing-in-assemblyscript/imaging.wasm'), {
      env: {
